...
export function ClassManager() {
    ...
    const handleViewHistory = (cls: Class) => {
            ...
            {classes.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {classes.map((cls) => {
                        ...
                        return (
                            <div key={cls.id} className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow relative group flex flex-col h-full">
                    ...
                    <div className="bg-white rounded-lg shadow-xl w-full max-w-sm border border-gray-100 animate-in fade-in zoom-in-95">
                        ...
                        <form onSubmit={handleSubmit} className="p-4 space-y-4">
                            <div>
                                ...
                                />
                                <p className="text-xs text-gray-500 mt-1">O sistema adicionará "º Ano" automaticamente.</p>
                            </div>
                    ...
                    <div className="bg-white rounded-lg shadow-xl w-full max-w-sm border border-gray-100 animate-in fade-in zoom-in-95">
                        <div className="flex items-center justify-between p-4 border-b border-pink-100 bg-pink-50 rounded-t-lg">
                            <div>
                                ...
                                <p className="text-xs text-pink-700 font-medium opacity-80">Ano Letivo {historyYear} • {viewingHistoryClass.period}</p>
                            </div>
                            <button onClick={() => setIsHistoryModalOpen(false)} className="text-pink-400 hover:text-pink-600 p-1 hover:bg-white/50 rounded-full transition-colors">
                                <X size={18} />
                            </button>
                        </div>
