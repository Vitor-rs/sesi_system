...
import { Plus, Search, Archive, UserX, AlertCircle, RefreshCw, Users, GraduationCap, Clock, X, Trash2, ArrowUpDown } from 'lucide-react'
                            ...
                            <div className="relative">
                                <div className="flex items-center gap-2 px-3 py-2 border border-gray-200 rounded-lg bg-white focus-within:ring-2 focus-within:ring-blue-500/20 focus-within:border-blue-500 transition-all">
                                    ...
                                    <div className="flex flex-col">
                                        <label className="text-[10px] text-gray-400 font-medium leading-none mb-0.5">FILTROS</label>
                                        <select
                                            value={sortBy}
                        ...
                        {filteredStudents.length > 0 ? (
                            <table className="w-full text-left border-collapse">
                                <thead className="bg-gray-100/80 border-b border-gray-200">
                                    <tr>
                                        <th className="px-6 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider w-16">#</th>
                                        <th className="px-6 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider w-1/3">Nome</th>
                                        <th className="px-6 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider">Turma</th>
                                        <th className="px-6 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider">Status</th>
                                        <th className="px-6 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider text-right w-48">Ações</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-gray-50">
                                    {filteredStudents.map((student, index) => {
                                        ...
                                        // Index Display Logic
                                        const displayIndex = sortBy === 'admission'
                                                    ...
                                                    {showArchived && (
                                                        <div className="relative group/delete">
                                                            <button
                                                                onClick={() => {
                                                                    if (hasDependencies) {
                                                                        alert("Este aluno possui histórico/notas e não pode ser excluído diretamente.")
                                                                    } else {
                                                                ...
                                                                title={hasDependencies ? "Não pode ser excluído (Possui histórico)" : "Excluir permanentemente"}
                                                            >
